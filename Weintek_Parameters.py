...
for j in structsList:
    ...
    for i in enList:
        if i == '1':
            ...
            str4 = '        SetData(TempShort, "Local HMI", "'+ structsList[currStructNumber] + '.' + varList[currNumVar] + '", 1)\n'
            str5 = '    else\n'
            str6 = '        GetData(TempShort, "Local HMI", "'+ structsList[currStructNumber] + '.' + varList[currNumVar] + '", 1)\n'
            ...
            str1 = '    GetData(TempShort, "Local HMI", "'+ structsList[currStructNumber] + '.' + varList[currNumVar] + '", 1)\n'
...
for j in structsList:
    currNumVar = 0
    for i in varList:
        str1 = '    SetData(ConstZero, "Local HMI", "'+ structsList[currStructNumber] + '.' + varList[currNumVar] + '", 1)'
        print(str1)
        outputFile.write(str1+'\n')
        currNumVar += 1
    currStructNumber += 1
